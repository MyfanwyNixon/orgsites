...
<section class="section-options">
	...
	<?php if(isset($public)):?>
		<li>
			...
			<p><a class="btn fms" href="<?php echo $public['url'];?>"><?php echo $public['text'];?></a></p>
		</li>
	<?php endif ?>
	<?php if(isset($document)):?>
		<li>
			...
			<p><a class="btn fms" href="<?php echo $document['url'];?>"><?php echo $document['text'];?></a></p>
		</li>
	<?php endif ?>
	<?php if(isset($wiki)):?>
		<li>
			...
			<p><a class="btn fms" href="<?php echo $wiki['url'];?>"><?php echo $wiki['text'];?></a></p>
		</li>
	<?php endif ?>
	...
	<?php if(isset($blog)):?><li>
			...
			<p><a class="btn fms" href="<?php echo $blog['url'];?>"><?php echo $blog['text'];?></a></p>
		</li>
	<?php endif ?>
	<?php if(isset($faq)):?>
		<li>
			...
			<p><a class="btn fms" href="<?php echo $faq['url'];?>"><?php echo $faq['text'];?></a></p>
		</li>
	<?php endif ?>
	<?php if(isset($facebook)):?><li>
			<h3>Like this?</h3>
			<p class="desc">You can follow us on Facebook.</p>
			<p><a class="btn fms" href="<?php echo $facebook['url'];?>"><?php echo $facebook['text'];?></a></p>
		</li>
	<?php endif ?>
	<?php if(isset($irc)):?>
		<li>
			...
			<p><a class="btn fms" href="<?php echo $irc['url'];?>"><?php echo $irc['text'];?></a></p>
		</li>
	<?php endif ?>
	<?php if(isset($group)): ?>
		<li>
			...
			<p><a class="btn fms" href="<?php echo $group['url'];?>"><?php echo $group['text'];?></a></p>
		</li>
	<?php endif ?>
	</ul>
</section>