...
// Temp col count fix
tempcolfix=function(){var a=$(".section-options ul").removeClass("four_up").removeClass("three_up").removeClass("two_up").children("li").length;var b="four_up";if(!section-options-count%3){b="three_up";}else{if(!section-options-count%4){b="four_up";}else{if(!section-options-count%2){b="two_up";}}}$(".section-options ul").addClass(b);};
