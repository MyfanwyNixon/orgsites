...
if (is_category()) {
	...
	echo '<p id="sidebar_rss"><a href="', get_category_feed_link($cat), '"><img align="top" src="https://secure.mysociety.org/cvstrac/getfile?f=mysociety/ms/web/feed.png&v=1.2" alt=""> RSS feed for this category</a></p>';
} else {
	echo '<p id="sidebar_rss"><a href="', bloginfo('rss2_url'), '"><img align="top" src="https://secure.mysociety.org/cvstrac/getfile?f=mysociety/ms/web/feed.png&v=1.2" alt=""> RSS feed</a></p>';
}
