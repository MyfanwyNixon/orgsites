...
<section id="main-content">
	...
	<?php if ( is_category() ) : ?>
	<h1 class="archive-cat-title"><?php single_cat_title(); ?></h1>
	<?php elseif( is_tag() ) : ?>
	<h1 class="archive-tag-title">Posts Tagged &ldquo;<?php single_tag_title(); ?>&rdquo;</h1>
	<?php elseif (is_day()) : ?>
	...
	<h1 class="archive-author-title">Author Archive</h1>
