...
// Temp col count fix
var tempcolfix=function(){var a=$(".section-options ul").removeClass("four_up").removeClass("three_up").removeClass("two_up").children("li").length;var b="three_up";if(!a%3){b="three_up";}else{if(!a%4){b="four_up";}else{if(!a%2){b="two_up";}}}$(".section-options ul").addClass(b);};
