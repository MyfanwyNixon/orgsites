...
Hold corporations and governments to account.</span>
      ...
      <a class="link_button_green_large" href="/about">Learn more »</a>
    </div>
    <div id="right_column">
...
<div id="frontpage_examples">
      ...
      <li>Translated into 10 languages (and counting...)</li>
        </ul>
    ...
    <div id="examples_1">
      <h3>How do I get started?</h3>
        <ul>
            ...
            <li>
               Download <a href="/wp-uploads/2012/10/Turbo-Transparency-v1.0.pdf">Turbo Transparency</a>, a paper about how and why to use Alaveteli for Freedom of Information systems</li>
            <li>Find out more <a href="/about">about the Alaveteli project</a></li>
            <li>Read the <a href="https://github.com/mysociety/alaveteli/wiki/Getting-started">Getting Started guide</a> on our wiki</li>
            ...
            <li>Developers might want to start with the <a href="https://github.com/mysociety/alaveteli/wiki/Developers-guide">technical overview</a>.</a>
        </ul>
    </div>
</div>
